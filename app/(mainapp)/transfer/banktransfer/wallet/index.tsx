...
const WalletTransfer = () => {
  ...
  const recipientHandle = String(params.walletAddress || "wallet address");
  ...
  return (
    ...
    >
      ...
      <View style={styles.pageHeader}>
        ...
        >
          Confirm the recipient and send money instantly to their wallet.
        </CustomText>
      </View>

      <TransferHeaderCard
        title={recipientName}
        subtitle="Wallet recipient"
        detail={recipientHandle}
      ...
      <CustomModal visible={previewOpen} onClose={() => setPreviewOpen(false)}>
        <View style={styles.modalContent}>
          ...
          >
            Review the transfer details before entering your PIN.
          </CustomText>
