...
import {
    ListRow,
    RankCard,
} from "@/components/leaderboard/LeaderboardCards";
...
(i>=NAMES.length
?String(Math.floor(i/NAMES.length))
:""),
...
const xpToOvertake =
ahead
?ahead.xPoints-currentUser.xPoints
:0;
...
?Math.min(
100,
(currentUser.xPoints/ahead.xPoints)*100
)
:100;
